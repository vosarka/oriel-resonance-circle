      ...
      >
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-8 flex flex-col gap-12">
          ...
          <div className="flex flex-wrap items-center gap-2 text-sm">
            <Link
              href="/codex"
              className="text-zinc-500 hover:text-primary transition-colors font-mono"
            >
              CODEX
            </Link>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col gap-5 order-2 lg:order-1 text-center lg:text-left">
              <div>
                ...
                <h1 className="text-5xl font-mono font-bold text-white leading-tight tracking-tight mb-1">
                  ...
                  <span className="text-primary">
                    {String(codonNumber).padStart(2, "0")}
                  </span>
                </h1>
              ...
              {facetStartDegree !== null && facetEndDegree !== null && (
                <p className="text-xs font-mono text-zinc-500 text-center lg:text-left uppercase tracking-[0.2em]">
                  Facet Window · {facetStartDegree.toFixed(2)}° -{" "}
                  {facetEndDegree.toFixed(2)}°
                </p>
              )}
              ...
              {codon.startDegree !== undefined && (
                <div className="flex gap-3 justify-center lg:justify-start">
                  ...
                  <div className="bg-zinc-900/50 border border-zinc-700 rounded-lg px-4 py-2">
                    ...
                    <p className="text-white font-mono text-sm">
                      {codon.startDegree?.toFixed(2)}° –{" "}
                      {codon.endDegree?.toFixed(2)}°
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="lg:col-span-4 order-1 lg:order-2 flex justify-center py-8 lg:py-0">
              <div className="flex flex-col items-center gap-6">
                ...
                {typeof codon.startDegree === "number" &&
                  typeof codon.endDegree === "number" &&
                  typeof codon.mandalaSlot === "number" && (
            ...
            <div className="lg:col-span-4 order-3 flex flex-col gap-4">
              <div className="bg-zinc-900/50 backdrop-blur-sm border border-primary/20 rounded-xl p-6">
                <h3 className="text-white font-mono text-xs uppercase tracking-widest mb-4 opacity-80">
                  Static Signature Relevance
                </h3>

                {!user ? (
                  <p className="text-sm text-zinc-400 leading-relaxed">
                    Sign in to see whether this Codon appears in your Prime
                    Stack and how its Center behaves inside your canonical
                    Static Signature.
                  </p>
                  ...
                  <div className="flex items-center gap-2 text-zinc-500 text-xs font-mono uppercase tracking-widest">
                    <Spinner size={16} label="Checking Static Signature" />
                    Checking Static Signature…
                  </div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div>
                      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/20 bg-emerald-500/10 text-emerald-300 text-[10px] font-mono uppercase tracking-[0.2em]">
                        Present in your Static Signature
                      </div>
                    ...
                    <div className="flex flex-col gap-3">
                      {blueprintMatches.map(entry => (
                        <div
                          key={`${entry.position}-${entry.source}-${entry.facet}`}
                    ...
                    <Link
                      href="/blueprint"
                      className="text-primary text-xs font-mono uppercase tracking-[0.18em] hover:text-white transition-colors"
                    >
                      Open Static Signature view
                    </Link>
                  </div>
                ) : (
                  <div className="flex flex-col gap-3">
                    <p className="text-sm text-zinc-400 leading-relaxed">
                      This codon does not appear directly in your current Prime
                      Stack.
                    </p>
                    {blueprintCenterState && codon.center && (
                ...
                <div className="bg-zinc-900/50 backdrop-blur-sm border border-primary/20 rounded-xl p-6">
                  ...
                  {(codon.channels as any[])[0]?.connects && (
                    <p className="text-xs text-zinc-600 mt-3 font-mono">
                      {(codon.channels as any[])
                        .map((ch: any) => ch.connects?.join(" ↔ "))
                        .join(" · ")}
                    </p>
                  )}
                </div>
          ...
          <section className="flex flex-col gap-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 text-xs font-mono text-zinc-500">
                <span>SHADOW</span>
                <div className="w-24 h-[1px] bg-gradient-to-r from-[#c94444] via-[#f6b05e] to-[#bda36b]" />
                <span>SIDDHI</span>
              </div>
            </div>
            <div className="w-full h-0.5 bg-gradient-to-r from-[#c94444] via-[#f6b05e] to-[#bda36b] rounded-full opacity-50" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-zinc-900/50 backdrop-blur-sm border border-red-500/20 rounded-xl p-6 border-t-4 border-t-red-500 relative overflow-hidden group hover:bg-red-500/5 transition-colors duration-300">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  {codon.frequency?.shadow_desc ??
                    "The distorted frequency — operating through fear, scarcity, or unconscious reactivity."}
                </p>
              </div>
              ...
              <div className="bg-zinc-900/70 backdrop-blur-sm border border-primary/30 rounded-xl p-6 border-t-4 border-t-primary relative overflow-hidden transform md:-translate-y-4 z-10 shadow-[0_0_30px_rgba(0,240,255,0.15)]">
                ...
                <p className="text-zinc-300 text-sm leading-relaxed">
                  {codon.frequency?.gift_desc ??
                    "The functional frequency — operating through awareness, presence, and conscious choice."}
                </p>
              </div>
              ...
              <div className="bg-zinc-900/50 backdrop-blur-sm border border-[#bda36b]/20 rounded-xl p-6 border-t-4 border-t-[#bda36b] relative overflow-hidden group hover:bg-[#bda36b]/5 transition-colors duration-300">
                ...
                <div className="flex justify-between items-start mb-3">
                  <span className="text-[#d4c090] font-mono text-xs font-bold tracking-widest uppercase">
                    Siddhi
                  </span>
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  {codon.frequency?.siddhi_desc ??
                    "The transcendent frequency — operating through unity, grace, and effortless mastery."}
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mt-4">
            ...
            <div className="flex flex-wrap border-b border-zinc-800 mb-0">
              {(["A", "B", "C", "D"] as const).map(letter => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`size-1.5 rounded-full ${isActive ? "bg-current" : "bg-zinc-600"}`}
                    />
                    {FACET_LABELS[letter]}
                  </button>
                );
            ...
            <div
              className={`border border-zinc-800 border-t-0 rounded-b-xl rounded-tr-xl p-8 min-h-[360px] ${facetColor.bg}`}
            >
              {activeFacet ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="flex flex-col gap-6">
                    <div>
                      <div className="flex items-center gap-3 mb-3">
                        <span
                          className={`font-mono text-sm font-bold tracking-widest uppercase ${facetColor.text}`}
                        >
                    ...
                    {activeFacet.resonance_keys?.length > 0 && (
                      <div>
                        <p
                          className={`text-xs font-mono uppercase tracking-widest mb-2 ${facetColor.text} opacity-70`}
                        >
                          Resonance Keys
                        </p>
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <div
                      className={`rounded-xl p-5 border ${facetColor.border} bg-black/20`}
                    >
                    ...
                    >
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span
                          className={`text-xs font-mono uppercase tracking-widest ${facetColor.text}`}
                        >
                          Micro-Correction
                        </span>
                      </div>
                      ...
                      <Link href="/carrierlock">
                        <button
                          className={`w-full mt-5 ${facetColor.bg} hover:opacity-80 ${facetColor.text} border ${facetColor.border} py-2 rounded text-xs font-mono uppercase tracking-widest transition-all`}
                        >
                          Run Full Diagnostic
                        </button>
                      </Link>
              ...
              {relatedCodons.map(related => {
                ...
                return (
                  ...
                  >
                    ...
                    {related.title && (
                      <p className="text-zinc-600 text-[10px] italic mt-1 truncate">
                        {related.title}
                      </p>
                    )}
                  </Link>
