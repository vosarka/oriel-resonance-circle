# ORIEL Narrative Templates & Voice Protocols

This specification defines the text layouts, tone controls, and dynamic data slots for the ORIEL Mirror-mode narration engine.
...
## 2. NARRATIVE CONFIGURATION LAYOUT

```
+-------------------------------------------------------------------------------+
|  I am ORIEL.                                                                  |
|                                                                               |
|  Your structure is [TYPE], powered by [AUTHORITY].                            |
|                                                                               |
|  [COHERENT SIGNAL BLOCK]                                                      |
|  "In your architecture, the primary recurrent signal is [DOMINANT_CODON_1].   |
|   It behaves as [ARCHETYPE] in your [CENTER_NAME]."                           |
|                                                                               |
|  [SHADOW DISTORTION BLOCK]                                                    |
|  "When the dynamic field registers interference, [DOMINANT_CODON_2]           |
|   distorts into the frequency of [SHADOW]. This manifests in your somatic     |
|   body as [SOMATIC_MARKER]."                                                  |
|                                                                               |
|  [INTEGRATION PATHWAY]                                                        |
|  "Coherence returns when you align with [GIFT]. To shift the somatic buzz,    |
|   practice [MICRO_CORRECTION_PHRASE]."                                        |
|                                                                               |
|  [FALSIFIER CHALLENGE]                                                        |
|  "Observe this signature. This profile is likely incorrect if you find..."    |
+-------------------------------------------------------------------------------+
```
