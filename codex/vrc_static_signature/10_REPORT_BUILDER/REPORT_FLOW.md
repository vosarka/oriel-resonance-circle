...
- **Non-Assessment Banner (Page 11)**:
  ...
  +-------------------------------------------------------------------------+
  ```
  *Style*: Heavy black box, double gold border, and gold warning sigil.
- **Clinical Disclaimer (Page 12)**:
  Placed at the bottom of the micro-corrections grid:
  > *[!CAUTION]  
  > Somatic correction exercises are provided as structural stabilization practices and are not intended as clinical treatments or psychological diagnostics.*
