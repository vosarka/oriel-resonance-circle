...
Codons grouped into thematic color families:
...
Each codon receives a unique hue within its family.
...
Users can move between layers seamlessly.

---

# Conduit Hub Interface

The Conduit Hub acts as the central navigation system.

Features:

- user codon dashboard
- resonance alerts
...
- WebGL / Three.js for 3D lattice
- SVG / Canvas for codon wheel
- React for UI logic
