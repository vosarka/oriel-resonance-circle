...
## New Features - Wireframe Face & Resume Button
- [x] Implement pause/resume toggle button
- [x] Create wireframe face component
- [x] Animate mouth movement during speech
- [x] Add glitch effects to face
- [x] Integrate face into Conduit page
- [x] Replace orb with face component
